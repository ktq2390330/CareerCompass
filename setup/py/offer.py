...
fixed_data = {
    ...
    "salaryRaise": "年2回",
    "bonus": "基本給6か月分",
    "allowances": "家賃手当・通勤手当・超過勤務手当・単身赴任手当",
    "solicitation": "【理系大・院、応募歓迎】理系大学、大学院の方でプログラム経験者歓迎！【文系】プログラム経験1ソース50行以上で応募可(未経験者不可)",
    "course": "ソフトウェアエンジニア職",
    "forms": "正社員",
    "roles": "ソフトウェアエンジニア",
    "CoB": "履歴書・職務経歴書・スキルシート",
    "subject": "大学院卒・大学卒・短大卒・専門学校卒",
    "NoP": "10 ~ 20人",
    "departments": "IT系学部歓迎！ 理系文系問わず応募可能です。",
    "characteristic": "プログラミング未経験者OK。",
}
