...
# 外部CSVファイルからデータを読み込む
area1names = cycle(load_csv_column("C:/Users/a_kaneko/CareerCompass/setup/data/area1.csv"))
category00names = cycle(load_csv_column("C:/Users/a_kaneko/CareerCompass/setup/data/category00.csv"))  # 会社種別
category01names = cycle(load_csv_column("C:/Users/a_kaneko/CareerCompass/setup/data/category01.csv"))  # 会社規模
category10names = cycle(load_csv_column("C:/Users/a_kaneko/CareerCompass/setup/data/category10.csv"))  # 会社形態
category11names = cycle(load_csv_column("C:/Users/a_kaneko/CareerCompass/setup/data/category11.csv"))  # 会社業種
corporationIDs = cycle(load_cId_column("C:/Users/a_kaneko/CareerCompass/setup/data/corporation.csv"))  # 会社ID
