"""
Django settings for CareerCompassProject project.
...
SECRET_KEY = 'django-insecure-#_s#p$78ckw*bx5!=ok^fvufp-f^)my0k#_9fb^df8a(@jov!l'
...
ROOT_URLCONF = 'CareerCompassProject.urls'
...
WSGI_APPLICATION = 'CareerCompassProject.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'careercompassdb'),
